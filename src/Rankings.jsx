...
// ── Palette: Slate dark + Gold accent + White text only ──────────────────────
// #0F172A  bg-slate-900   (page background)
// #1E293B  bg-slate-800   (card / surface)
// #334155  bg-slate-700   (border / divider)
// #F8FAFC  text white
// #94A3B8  text-slate-400 (muted)
// #F59E0B  amber-400      (single accent — gold)
